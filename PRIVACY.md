<!-- Generated from legal-content.js. Edit that source, then run npm run legal. -->

# Secret Brush — Gizlilik / Privacy
...
#### 2. Cihazınızda kullanılan bilgiler
...
#### 3. Yakındaki oyuncularla paylaşılan bilgiler
...
#### 6. Toplama, satış, takip ve reklam
...
#### 3. Information shared with nearby players
...
#### 6. Collection, sale, tracking, and advertising
